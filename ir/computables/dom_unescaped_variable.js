 ...
 */
function DOMUnescapedVariable(scope, value, placement) {
...
inherits(DOMUnescapedVariable, Computable);

/**
 * @override
 */
DOMUnescapedVariable.prototype._clone = function (scope, input_computables) {
  return new DOMUnescapedVariable(scope, input_computables[1], input_computables[0]);
};

/**
 * @override
 */
DOMUnescapedVariable.prototype.is_side_effect_causing = function () {
  return true;
};
 ...
 * @override
 */
DOMUnescapedVariable.prototype._validate_input = function (index, computable) {
  ...
  if (index === 0 && !(computable_output_type instanceof IRDOMPlacementType)) {
    ...
    throw new Error("DOMUnescapedVariable expects only a placement and value computable");
  }
};

module.exports = DOMUnescapedVariable;
